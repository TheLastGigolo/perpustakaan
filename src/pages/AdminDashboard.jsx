          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-lg lg:text-xl font-semibold text-gray-800">Aktivitas Terbaru</h2>
                  <p className="text-sm text-gray-600">Peminjaman dan pengembalian hari ini</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4 p-4 bg-green-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800">
                    Buku "JavaScript untuk Pemula" dipinjam oleh Ahmad Santoso
                  </p>
              ...
              <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800">
                    Buku "Python Data Science" dikembalikan oleh Siti Nurhaliza
                  </p>
              ...
              <div className="flex items-center space-x-4 p-4 bg-amber-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800">
                    Anggota baru "Budi Setiawan" terdaftar
                  </p>
              ...
              <div className="flex items-center space-x-4 p-4 bg-red-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800">
                    Buku "Database Fundamentals" melewati batas waktu peminjaman
                  </p>
