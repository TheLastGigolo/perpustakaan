...
<div class="dropdown">
    <button class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" id="filterBtn">Filter</button>
...
<div style="margin-left: 250px; padding: 100px 30px 30px 30px;">
    <h3 style="background-color: #E8F5E9; display: inline-block; padding: 10px 20px; border-radius: 20px; color: #333;">Data Peminjaman</h3>
    ...
    <div class="card mt-4">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                ...
                <input type="text" id="searchInput" class="form-control w-25" placeholder="Search for reports">
            </div>

            <table class="table table-bordered table-hover text-center" id="peminjamanTable">
                ...
                <tbody>
                    <!-- Data dummy -->
                    <tr data-date="2025-05-31">
                        <td>1</td>
                        <td>Menjadi Teknisi Komputer</td>
                        <td>Rafly Rachman</td>
                        <td>2025-05-31</td>
                        <td>2025-06-03</td>
                        <td>
                    ...
                    <tr data-date="2025-05-10">
                        <td>3</td>
                        <td>Algoritma dan Struktur Data</td>
                        <td>Rahmat Pratama</td>
                        <td>2025-05-10</td>
                        <td>2025-05-15</td>
                        <td>
                            <button class="btn btn-sm btn-danger">Reject</button>
...
<script>
    // Fungsi bantu untuk normalisasi tanggal
    ...
    // Cek apakah tanggal masuk minggu ini
    ...
    // Cek apakah tanggal masih dalam bulan ini
    ...
    document.querySelectorAll('.filter-option').forEach(option => {
        option.addEventListener('click', function (e) {
            ...
            // Ubah label tombol filter (opsional)
